        ...
        <div className="container">
          ...
          <div className="ranks-intro reveal">
            ...
            <div className="ranks-vs" style={{ borderColor: 'rgba(96,165,250,.18)', background: 'linear-gradient(135deg,rgba(96,165,250,.05),rgba(34,211,238,.03))' }}>
              ...
              <div className="ranks-vs-row"><span className="badge r">Games</span><div><b>~70% of XP</b><span>Skill-based play in Prism League — Orbit, Gravity, Cosmic Wars.</span></div></div>
      ...
      <section id="games">
        <div className="container">
          ...
          <div className="games-grid reveal-stagger">
            <div className="game-card"><img src="/landing/games/orbit_cover.png" alt="" className="cover" /><div className="veil"></div><div className="body"><div className="pill">Live · Solo</div><h3>Orbit Survival</h3><p className="gdesc">Navigate asteroid fields. Reflexes &amp; reaction time scored in real-time.</p><div className="stats"><div className="stat"><b>Solo</b></div><div className="stat"><b>Realtime</b></div><div className="stat"><b>+25 XP</b></div></div></div></div>
            <div className="game-card"><img src="/landing/games/gravity_cover.png" alt="" className="cover" /><div className="veil"></div><div className="body"><div className="pill">Live · Solo</div><h3>Gravity Runner</h3><p className="gdesc">Physics-driven obstacle course. Pure motor skill — impossible to script.</p><div className="stats"><div className="stat"><b>Solo</b></div><div className="stat"><b>Physics</b></div><div className="stat"><b>+30 XP</b></div></div></div></div>
            <div className="game-card"><img src="/landing/games/wars_cover.png" alt="" className="cover" /><div className="veil"></div><div className="body"><div className="pill">Live · Arena</div><h3>Cosmic Wars</h3><p className="gdesc">Wallet-vs-wallet PvP arena. Combat as score-multiplier.</p><div className="stats"><div className="stat"><b>PvP</b></div><div className="stat"><b>1v1</b></div><div className="stat"><b>+50 XP</b></div></div></div></div>
            <div className="game-card"><img src="/landing/games/quest_cover.png" alt="" className="cover" /><div className="veil"></div><div className="body"><div className="pill">Live · Adventure</div><h3>Cosmic Quests</h3><p className="gdesc">Narrative-driven mission chains. Lore-locked badges &amp; XP rewards.</p><div className="stats"><div className="stat"><b>Story</b></div><div className="stat"><b>Daily</b></div><div className="stat"><b>+40 XP</b></div></div></div></div>
            <div className="game-card"><img src="/landing/games/wars_cover.png" alt="" className="cover" style={{ filter: 'hue-rotate(40deg) brightness(.8)' }} /><div className="veil"></div><div className="body"><div className="pill">Live · Tournament</div><h3>Prism Cup</h3><p className="gdesc">Seasonal bracket tournaments. Real prize pools, on-chain payouts.</p><div className="stats"><div className="stat"><b>Tournament</b></div><div className="stat"><b>Seasonal</b></div><div className="stat"><b>+100 XP</b></div></div></div></div>
          </div>
        </div>
      </section>
      ...
      <section id="ecosystem">
        <div className="container">
          ...
          <div className="eco-grid reveal-stagger">
            ...
            <div className="eco-card eco-c-forge"><span className="eco-tag">Cosmetics</span><div className="eco-icon"><img src="/landing/hub/shop.png" alt="" /></div><h3>Stellar Forge</h3><p>Craft ship skins, frames, auras, and titles. Equip them on your identity card or your in-game ship. Rank-gated.</p><div className="eco-feats"><div className="eco-feat">100+ cosmetic items</div><div className="eco-feat">Ship stat boosts</div><div className="eco-feat">Tradeable as NFTs</div></div></div>
            ...
            <div className="eco-card eco-c-blackhole"><span className="eco-tag">Burn</span><div className="eco-icon"><img src="/landing/hub/blackhole.png" alt="" /></div><h3>Black Hole</h3><p>Burn dust tokens &amp; abandoned NFTs. Reclaim SOL rent. 15% of every tournament fee burns here.</p><div className="eco-feats"><div className="eco-feat">Reclaim SOL rent</div><div className="eco-feat">Deflationary burn</div><div className="eco-feat">Tournament fee sink</div></div></div>
            ...
            <div className="eco-card eco-c-league"><span className="eco-tag">Skill</span><div className="eco-icon"><img src="/landing/hub/league.png" alt="" /></div><h3>Prism League</h3><p>The home of all skill games. Orbit Survival, Gravity Runner, Cosmic Wars &amp; Cosmic Quests in active rotation.</p><div className="eco-feats"><div className="eco-feat">4+ live games</div><div className="eco-feat">Active rotation</div><div className="eco-feat">XP attestation</div></div></div>
          </div>
        </div>
      </section>
