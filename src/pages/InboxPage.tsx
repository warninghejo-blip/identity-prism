          ...
          {!loading &&
            notifications.map((n) => {
              ...
              return (
                <div
                  key={n.id}
                  className={`flex items-center gap-3 px-4 py-3 border-b border-white/[0.04] cursor-pointer hover:bg-white/[0.02] transition-colors ${n.read ? 'opacity-50' : ''}`}
                  onClick={() => {
                ...
                >
                  {/* Unread dot */}
                  <div
                    className="w-1.5 h-1.5 rounded-full flex-shrink-0 bg-cyan-400"
