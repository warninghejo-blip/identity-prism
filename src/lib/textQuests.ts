...
const QUEST_ABANDONED_STATION: TextQuest = {
  ...
  nodes: {
    ...
    scan: {
      ...
      choices: [
        {
          text: 'Dock and head to cargo bay',
          nextNode: 'cargo_bay',
          effects: [{ variable: 'trust', op: '+', value: 1 }],
        },
    ...
    cargo_bay: {
      ...
      choices: [
        {
          text: 'Take the tech components',
          nextNode: 'take_cargo',
          effects: [{ variable: 'cargo', op: '+', value: 3 }],
        },
    ...
    bridge: {
      ...
      choices: [
        {
          text: 'Download the research data',
          nextNode: 'ending_data',
          effects: [{ variable: 'trust', op: '+', value: 2 }],
        },
...
const QUEST_PIRATE_AMBUSH: TextQuest = {
  ...
  nodes: {
    ...
    fight_start: {
      ...
      choices: [
        {
          text: 'Focus fire on the lead ship',
          nextNode: 'fight_aggressive',
          effects: [{ variable: 'ammo', op: '-', value: 5 }],
        },
        {
          text: 'Disable their engines',
          nextNode: 'fight_tactical',
          effects: [{ variable: 'ammo', op: '-', value: 3 }],
        },
      ],
    },
    fight_aggressive: {
      ...
      choices: [
        {
          ...
          nextNode: 'ending_fight_win',
          effects: [
            { variable: 'credits', op: '+', value: 500 },
            { variable: 'reputation', op: '+', value: 3 },
          ],
        },
      ],
    },
    fight_tactical: {
      ...
      choices: [
        {
          text: 'Take their cargo and leave',
          nextNode: 'ending_merciful',
          effects: [
            { variable: 'credits', op: '+', value: 600 },
            { variable: 'reputation', op: '+', value: 5 },
          ],
        },
        {
          text: 'Report them to patrol',
          nextNode: 'ending_lawful',
          effects: [{ variable: 'reputation', op: '+', value: 8 }],
        },
      ],
    },
    flee: {
      ...
      choices: [
        ...
        {
          text: 'Lead them into asteroid field',
          nextNode: 'asteroid_trap',
          effects: [{ variable: 'reputation', op: '+', value: 1 }],
        },
      ],
    },
    asteroid_trap: {
      ...
      choices: [
        {
          text: 'Grab the cargo pod and jump',
          nextNode: 'ending_clever',
          effects: [{ variable: 'credits', op: '+', value: 300 }],
        },
      ],
    },
    negotiate: {
      ...
      choices: [
        {
          text: 'Offer to trade route information',
          nextNode: 'trade_intel',
          effects: [{ variable: 'reputation', op: '-', value: 2 }],
        },
        {
          text: 'Offer to hire them as escorts',
          nextNode: 'hire_pirates',
          effects: [{ variable: 'credits', op: '-', value: 200 }],
        },
      ...
      choices: [
        {
          ...
          nextNode: 'ending_grey',
          effects: [{ variable: 'credits', op: '+', value: 150 }],
        },
      ],
    },
    hire_pirates: {
      ...
      choices: [
        {
          text: 'Thank them and part ways',
          nextNode: 'ending_alliance',
          effects: [{ variable: 'reputation', op: '+', value: 3 }],
        },
      ],
    },
    duel: {
      ...
      choices: [
        {
          text: 'Accept the honor prize',
          nextNode: 'ending_honor',
          effects: [
            { variable: 'credits', op: '+', value: 800 },
            { variable: 'reputation', op: '+', value: 10 },
          ],
        },
      ],
    },
    bluff: {
      ...
      choices: [{ text: 'Fly away, trying not to laugh', nextNode: 'ending_bluff' }],
    },
    ending_fight_win: {
      id: 'ending_fight_win',
...
const QUEST_DARK_MATTER: TextQuest = {
  ...
  description:
    'A massive dark matter anomaly distorts space around your ship. Incredible scientific opportunity — or deadly trap?',
  ...
  nodes: {
    start: {
      ...
      choices: [
        {
          text: 'Approach cautiously and scan',
          nextNode: 'approach',
          effects: [{ variable: 'risk', op: '+', value: 10 }],
        },
    ...
    approach: {
      ...
      choices: [
        {
          text: 'Go deeper — maximize data',
          nextNode: 'deep_scan',
          effects: [
            { variable: 'risk', op: '+', value: 25 },
            { variable: 'data', op: '+', value: 30 },
          ],
        },
        {
          text: 'Maintain safe distance, scan longer',
          nextNode: 'safe_scan',
          effects: [
            { variable: 'data', op: '+', value: 15 },
            { variable: 'energy', op: '-', value: 10 },
          ],
        },
    ...
    probe: {
      ...
      choices: [
        {
          text: 'Follow the probe inside',
          nextNode: 'deep_scan',
          effects: [
            { variable: 'risk', op: '+', value: 20 },
            { variable: 'data', op: '+', value: 20 },
          ],
        },
        {
          text: 'Analyze the structures from here',
          nextNode: 'analyze_structures',
          effects: [{ variable: 'data', op: '+', value: 25 }],
        },
        {
          text: 'Recall probe — too dangerous',
          nextNode: 'safe_scan',
          effects: [{ variable: 'data', op: '+', value: 10 }],
        },
      ],
    },
    reinforce: {
      ...
      choices: [
        {
          text: 'Enter the anomaly edge',
          nextNode: 'deep_scan',
          effects: [
            { variable: 'data', op: '+', value: 30 },
            { variable: 'risk', op: '+', value: 10 },
          ],
        },
        {
          text: 'Collect data and withdraw',
          nextNode: 'ending_scientific',
          effects: [{ variable: 'data', op: '+', value: 40 }],
        },
      ],
    },
    safe_scan: {
      ...
      choices: [
        {
          ...
          nextNode: 'decode_signal',
          effects: [{ variable: 'data', op: '+', value: 20 }],
        },
        {
          text: 'Record and leave — enough risk',
          nextNode: 'ending_scientific',
          effects: [{ variable: 'data', op: '+', value: 10 }],
        },
      ],
    ...
    analyze_structures: {
      ...
      choices: [
        {
          text: 'Enter the anomaly to investigate',
          nextNode: 'deep_scan',
          effects: [
            { variable: 'risk', op: '+', value: 30 },
            { variable: 'data', op: '+', value: 35 },
          ],
        },
        {
          text: 'Broadcast discovery to Science Council',
          nextNode: 'ending_discovery',
          effects: [{ variable: 'data', op: '+', value: 30 }],
        },
      ],
    },
    deep_scan: {
      ...
      choices: [
        {
          text: 'Collect a crystal sample',
          nextNode: 'crystal_grab',
          effects: [
            { variable: 'risk', op: '+', value: 20 },
            { variable: 'energy', op: '-', value: 20 },
          ],
        },
        {
          text: 'Scan the crystals and retreat',
          nextNode: 'ending_explorer',
          effects: [{ variable: 'data', op: '+', value: 40 }],
        },
        {
          text: 'Navigate deeper toward the center',
          nextNode: 'center',
          effects: [
            { variable: 'risk', op: '+', value: 40 },
            { variable: 'energy', op: '-', value: 30 },
          ],
          skillCheck: { stat: 'speed', min: 60 },
        },
      ],
    },
    crystal_grab: {
      ...
      choices: [
        {
          text: 'FULL THRUST — get out now!',
          nextNode: 'ending_crystal_escape',
          effects: [{ variable: 'energy', op: '-', value: 25 }],
        },
        {
          text: 'Grab another crystal on the way out',
          nextNode: 'ending_greedy',
          effects: [{ variable: 'risk', op: '+', value: 30 }],
          skillCheck: { stat: 'luck', min: 70 },
        },
      ],
    },
    center: {
      ...
      choices: [
        ...
        {
          text: 'Attempt to activate the gateway',
          nextNode: 'ending_gateway',
          effects: [{ variable: 'risk', op: '+', value: 50 }],
        },
      ],
    },
    decode_signal: {
      ...
      choices: [
        {
          text: 'Follow the coordinates inside',
          nextNode: 'deep_scan',
          effects: [
            { variable: 'risk', op: '+', value: 25 },
            { variable: 'data', op: '+', value: 25 },
          ],
        },
        {
          text: 'Record and report to Science Council',
          nextNode: 'ending_signal',
          effects: [{ variable: 'data', op: '+', value: 35 }],
        },
      ],
    },
    ending_cautious: {
...
const QUEST_PRISON_BREAK: TextQuest = {
  ...
  title: 'Prison Break',
  description:
    'Falsely imprisoned on a Malok planet. The charges are fabricated, the guards are corrupt, and the exit is locked. Find a way out before your trial — which is not going to be fair.',
  ...
  nodes: {
    ...
    inspect_cell: {
      ...
      choices: [
        {
          text: 'Start loosening the vent grate quietly',
          nextNode: 'start_tunnel',
          effects: [{ variable: 'intel', op: '+', value: 2 }],
        },
        {
          text: 'Keep the info and talk to the guard first',
          nextNode: 'talk_guard',
          effects: [{ variable: 'intel', op: '+', value: 1 }],
        },
      ],
    },
    talk_guard: {
      ...
      choices: [
        {
          text: 'Offer to help Vrrk expose Draal if he lets you out',
          nextNode: 'bribe_guard',
          effects: [{ variable: 'allies', op: '+', value: 1 }],
        },
        {
          text: 'Ask Vrrk about the prison layout',
          nextNode: 'prison_layout',
          effects: [{ variable: 'intel', op: '+', value: 1 }],
        },
        {
          text: 'Try to overpower him when he opens the door',
          nextNode: 'fight_guard',
          skillCheck: { stat: 'firepower', min: 45 },
        },
      ],
    },
    shout_lawyer: {
      ...
      choices: [
        {
          text: 'Give Squix the ration bars — send a message',
          nextNode: 'use_ally',
          effects: [{ variable: 'allies', op: '+', value: 2 }],
        },
        {
          text: 'Ask Squix about the tunnels instead',
          nextNode: 'start_tunnel',
          effects: [{ variable: 'intel', op: '+', value: 1 }],
        },
      ],
    ...
    prison_layout: {
      ...
      choices: [
        {
          text: 'Plan to move during the midnight shift change',
          nextNode: 'midnight_run',
          effects: [{ variable: 'intel', op: '+', value: 2 }],
        },
        {
          text: 'Combine this with the tunnel map — dual approach',
          nextNode: 'start_tunnel',
          effects: [{ variable: 'intel', op: '+', value: 1 }],
        },
      ],
    ...
    bribe_guard: {
      ...
      choices: [
        ...
        {
          text: 'Wait for the midnight shift — safer with timing',
          nextNode: 'midnight_run',
          effects: [{ variable: 'allies', op: '+', value: 1 }],
        },
      ],
    ...
    start_tunnel: {
      ...
      choices: [
        ...
        {
          text: 'Take your time — listen at each junction',
          nextNode: 'tunnel_careful',
          effects: [{ variable: 'intel', op: '+', value: 1 }],
        },
      ],
    },
    ...
    tunnel_luck: {
      ...
      choices: [{ text: 'Stow away in the transport', nextNode: 'ending_tunnel' }],
    },
    tunnel_careful: {
      id: 'tunnel_careful',
    ...
    use_riot: {
      ...
      choices: [
        {
          text: 'Over the fence while the guards are busy',
          nextNode: 'ending_riot',
          skillCheck: { stat: 'speed', min: 40 },
        },
        {
          text: 'Grab a guard uniform in the confusion',
          nextNode: 'ending_riot',
          effects: [{ variable: 'allies', op: '+', value: 1 }],
        },
      ],
    ...
    forged_order: {
      ...
      image: '/quests/prison_05.jpg',
      choices: [{ text: 'Walk out the front door like you own the place', nextNode: 'ending_hack' }],
    },
    sprint_exit: {
      id: 'sprint_exit',
      ...
      image: '/quests/prison_08.jpg',
      choices: [{ text: "Keep running — don't look back", nextNode: 'ending_riot' }],
    },
    ending_tunnel: {
      id: 'ending_tunnel',
...
const QUEST_DOMINATOR_FACTORY: TextQuest = {
  ...
  description:
    'Deep in enemy territory, a Dominator production complex churns out battle robots by the thousands. Your mission: get in, plant charges, and get out. Simple. Nothing about this will be simple.',
  ...
  nodes: {
    start: {
      ...
      choices: [
        ...
        {
          text: 'Steal a Dominator maintenance unit for cover',
          nextNode: 'disguise_approach',
          skillCheck: { stat: 'luck', min: 55 },
        },
        {
          text: 'Scout the perimeter thoroughly first',
          nextNode: 'scout_perimeter',
          effects: [{ variable: 'intel', op: '+', value: 2 }],
        },
      ],
    },
    scout_perimeter: {
      ...
      choices: [
        {
          text: 'Access the data relay tower',
          nextNode: 'data_relay',
          effects: [{ variable: 'intel', op: '+', value: 3 }],
        },
        {
          text: 'Use the 90-second gap at the east entrance',
          nextNode: 'east_entrance',
          effects: [{ variable: 'intel', op: '+', value: 1 }],
        },
      ],
    },
    ...
    disguise_approach: {
      ...
      choices: [
        {
          text: 'Head straight for the main reactor with your charges',
          nextNode: 'reactor_plant',
          effects: [{ variable: 'intel', op: '+', value: 1 }],
        },
        {
          text: 'Access a terminal and steal production intel first',
          nextNode: 'steal_intel',
          effects: [{ variable: 'intel', op: '+', value: 3 }],
        },
      ],
    },
    data_relay: {
      ...
      choices: [
        {
          text: 'Use the schematics — hit all three production nodes',
          nextNode: 'east_entrance',
          effects: [{ variable: 'intel', op: '+', value: 2 }],
        },
        {
          text: 'Prioritize rescuing the prisoner',
          nextNode: 'east_entrance',
          effects: [{ variable: 'intel', op: '+', value: 1 }],
        },
      ],
    ...
    east_entrance: {
      ...
      choices: [
        ...
        {
          text: 'Use the jammer to blind their sensors',
          nextNode: 'jammer_use',
          effects: [{ variable: 'detection', op: '+', value: 1 }],
        },
        {
          text: 'Take a longer route through maintenance tunnels',
          nextNode: 'assembly_floor',
          effects: [{ variable: 'intel', op: '+', value: 1 }],
        },
      ],
    },
    assembly_floor: {
      ...
      choices: [
        {
          text: 'Plant charges on the power couplings and fabricators',
          nextNode: 'plant_two_charges',
          condition: { variable: 'charges', op: '>=', value: 2 },
        },
        {
          text: 'Plant all three charges for maximum damage',
          nextNode: 'plant_all_charges',
          condition: { variable: 'charges', op: '>=', value: 3 },
        },
    ...
    control_room_approach: {
      ...
      choices: [
        {
          text: 'Disable the supervisors and access the terminal',
          nextNode: 'control_room_hack',
          skillCheck: { stat: 'firepower', min: 45 },
        },
        {
          text: 'Wait for a diagnostic cycle — they go dormant',
          nextNode: 'control_room_sneak',
          condition: { variable: 'intel', op: '>=', value: 2 },
        },
      ],
    },
    sneak_patrol: {
      ...
      choices: [
        {
          text: 'Head for the reactor core',
          nextNode: 'reactor_plant',
          condition: { variable: 'charges', op: '>=', value: 1 },
        },
    ...
    jammer_use: {
      ...
      choices: [
        {
          text: 'Move fast — hit the reactor and run',
          nextNode: 'reactor_plant',
          effects: [{ variable: 'detection', op: '+', value: 1 }],
          condition: { variable: 'charges', op: '>=', value: 1 },
        },
        {
          text: 'Find a terminal and wipe the anomaly flag',
          nextNode: 'steal_intel',
          effects: [{ variable: 'intel', op: '+', value: 1 }],
        },
      ],
    ...
    steal_intel: {
      ...
      choices: [
        {
          text: "Grab the data and abort — don't risk it",
          nextNode: 'ending_intel_only',
          effects: [{ variable: 'intel', op: '+', value: 3 }],
        },
        {
          text: 'Data secured — now plant the charges',
          nextNode: 'reactor_plant',
          effects: [
            { variable: 'detection', op: '+', value: 1 },
            { variable: 'intel', op: '+', value: 3 },
          ],
          condition: { variable: 'charges', op: '>=', value: 1 },
        },
      ],
    ...
    control_room_hack: {
      ...
      choices: [
        {
          text: 'Trigger the complete factory shutdown',
          nextNode: 'ending_stealth_sabotage',
          condition: { variable: 'detection', op: '<=', value: 2 },
        },
        {
          text: 'Download the AI core and trigger shutdown',
          nextNode: 'ending_complete_destruction',
          effects: [{ variable: 'intel', op: '+', value: 5 }],
        },
      ],
    },
    control_room_sneak: {
      ...
      image: '/quests/robots_05.jpg',
      choices: [{ text: 'Initiate factory-wide destruction sequence', nextNode: 'ending_complete_destruction' }],
    },
    plant_two_charges: {
      ...
      choices: [
        ...
        {
          text: 'Get out fast — alarm or no alarm',
          nextNode: 'escape_detected',
          condition: { variable: 'detection', op: '>=', value: 3 },
        },
      ],
    },
    plant_all_charges: {
      ...
      image: '/quests/robots_03.jpg',
      choices: [{ text: 'Run for the exit — everything is in motion', nextNode: 'ending_complete_destruction' }],
    },
    reactor_plant: {
      id: 'reactor_plant',
      ...
      choices: [
        {
          text: 'Plant one charge and get out',
          nextNode: 'ending_stealth_sabotage',
          effects: [{ variable: 'charges', op: '-', value: 1 }],
          condition: { variable: 'detection', op: '<=', value: 2 },
        },
        {
          text: 'Plant two charges — total destruction',
          nextNode: 'ending_complete_destruction',
          effects: [{ variable: 'charges', op: '-', value: 2 }],
          skillCheck: { stat: 'shield', min: 45 },
        },
        {
          text: 'Alarms going off — fight your way out',
          nextNode: 'escape_detected',
          condition: { variable: 'detection', op: '>=', value: 3 },
        },
      ],
...
const QUEST_ELECTION_DAY: TextQuest = {
  ...
  title: 'Election Day',
  description:
    'Governor Plox of Colony Vesta-4 needs a campaign manager. You need cash. It seemed like a good match. Then you met the other candidate.',
  ...
  nodes: {
    start: {
      ...
      choices: [
        {
          text: 'Organize a public rally at the spaceport',
          nextNode: 'rally',
          effects: [{ variable: 'votes', op: '+', value: 2 }],
        },
    ...
    rally: {
      ...
      choices: [
        {
          text: 'Defend the Governor — blame bureaucratic delays',
          nextNode: 'defend_governor',
          effects: [{ variable: 'votes', op: '+', value: 1 }],
        },
        {
          text: 'Pivot to future promises — new spaceport by next year',
          nextNode: 'new_promise',
          effects: [
            { variable: 'votes', op: '+', value: 2 },
            { variable: 'scandal', op: '+', value: 1 },
          ],
        },
        {
          text: 'Quietly offer Journalist Meen a scoop on Zrix instead',
          nextNode: 'investigate_zrix',
          effects: [{ variable: 'scandal', op: '+', value: 1 }],
        },
      ],
    },
    survey: {
      ...
      choices: [
        {
          text: 'Announce an emergency water fix — spend 50 credits',
          nextNode: 'fix_water',
          effects: [
            { variable: 'money', op: '-', value: 50 },
            { variable: 'votes', op: '+', value: 3 },
          ],
        },
        {
          text: "Expose Zrix's secret trade route support",
          nextNode: 'expose_zrix',
          effects: [
            { variable: 'votes', op: '+', value: 2 },
            { variable: 'scandal', op: '+', value: 1 },
          ],
        ...
        {
          text: 'Address the cousin rumor directly',
          nextNode: 'address_rumor',
          effects: [{ variable: 'scandal', op: '+', value: 1 }],
        },
      ],
    },
    investigate_zrix: {
      ...
      choices: [
        {
          text: 'Release the information to the press — clean and legitimate',
          nextNode: 'expose_zrix',
          effects: [{ variable: 'votes', op: '+', value: 2 }],
        },
        {
          text: 'Approach Zrix privately — suggest he withdraw',
          nextNode: 'blackmail_zrix',
          effects: [{ variable: 'scandal', op: '+', value: 2 }],
        },
        {
          text: 'Hold the info as insurance and focus on positive campaign',
          nextNode: 'positive_campaign',
          effects: [{ variable: 'votes', op: '+', value: 1 }],
        },
      ],
    },
    defend_governor: {
      ...
      choices: [
        {
          text: 'Push for the final vote — hold a second rally',
          nextNode: 'final_push',
          effects: [{ variable: 'votes', op: '+', value: 1 }],
        },
    ...
    new_promise: {
      ...
      choices: [
        {
          text: 'Double down — announce more ambitious promises',
          nextNode: 'final_push',
          effects: [
            { variable: 'votes', op: '+', value: 2 },
            { variable: 'scandal', op: '+', value: 1 },
    ...
    fix_water: {
      ...
      choices: [
        {
          text: 'Capitalize — hold an event at the newly fixed facility',
          nextNode: 'final_push',
          effects: [{ variable: 'votes', op: '+', value: 2 }],
        },
      ],
    ...
    expose_zrix: {
      ...
      choices: [
        {
          text: 'Follow up with a policy debate challenge',
          nextNode: 'final_push',
          effects: [{ variable: 'votes', op: '+', value: 1 }],
        },
    ...
    address_rumor: {
      ...
      choices: [
        {
          text: 'Run with "the honest Governor" narrative',
          nextNode: 'positive_campaign',
          effects: [
            { variable: 'votes', op: '+', value: 2 },
            { variable: 'scandal', op: '-', value: 1 },
    ...
    blackmail_zrix: {
      ...
      choices: [
        {
          text: 'Weather the scandal — keep working',
          nextNode: 'check_polls',
          effects: [
            { variable: 'scandal', op: '+', value: 2 },
            { variable: 'votes', op: '-', value: 2 },
          ],
        },
      ],
    ...
    positive_campaign: {
      ...
      choices: [
        {
          text: 'Hold a final town hall and let Plox speak honestly',
          nextNode: 'final_push',
          effects: [{ variable: 'votes', op: '+', value: 2 }],
        },
      ],
    ...
    check_polls: {
      ...
      choices: [
        {
          text: 'Make a final push — get out the vote',
          nextNode: 'final_push',
          effects: [{ variable: 'votes', op: '+', value: 1 }],
        },
    ...
    final_push: {
      ...
      image: '/quests/election_00.jpg',
      choices: [{ text: 'See the results', nextNode: 'check_outcome' }],
    },
    check_outcome: {
      id: 'check_outcome',
      ...
      choices: [
        {
          text: 'A clean campaign won the day',
          nextNode: 'ending_honest_win',
          condition: { variable: 'votes', op: '>=', value: 5 },
        },
        {
          text: 'The scandal broke everything',
          nextNode: 'ending_scandal_loss',
          condition: { variable: 'scandal', op: '>=', value: 3 },
        },
...
const QUEST_ALIEN_ZOO: TextQuest = {
  ...
  title: 'Alien Zoo',
  description:
    'The curator of the famous Xenopark is sick. You agreed to cover for one day. How hard can it be? The park contains 34 species, 3 of which are "conditionally docile."',
  ...
  nodes: {
    start: {
      ...
      choices: [
        ...
        {
          text: 'Check the zoo map and review all enclosures',
          nextNode: 'check_map',
          effects: [{ variable: 'safety', op: '+', value: 1 }],
        },
    ...
    check_map: {
      ...
      choices: [
        {
          text: 'Complete the feeding rounds before opening',
          nextNode: 'morning_feeding',
          effects: [{ variable: 'happiness', op: '+', value: 1 }],
        },
        { text: 'Check in on the slime-hound first', nextNode: 'slime_hound' },
        {
          text: 'Prepare the gift shop — maximize visitor spending',
          nextNode: 'gift_shop',
          effects: [{ variable: 'profit', op: '+', value: 2 }],
        },
      ],
    },
    morning_feeding: {
      ...
      choices: [
        ...
        {
          text: 'Open the park anyway — maybe it returns on its own',
          nextNode: 'park_open',
          effects: [{ variable: 'safety', op: '-', value: 2 }],
        },
      ],
    },
    slime_hound: {
      ...
      choices: [
        {
          text: 'Sing to it — auditory stimulation, technically',
          nextNode: 'calm_creature',
          skillCheck: { stat: 'luck', min: 35 },
        },
        {
          text: 'Give it the enrichment toy from the supply cabinet',
          nextNode: 'calm_creature',
          effects: [{ variable: 'happiness', op: '+', value: 1 }],
        },
        {
          text: 'Leave it alone and hope it settles',
          nextNode: 'park_open',
          effects: [{ variable: 'safety', op: '-', value: 1 }],
        },
      ],
    ...
    gift_shop: {
      ...
      choices: [
        ...
        {
          text: 'Do the morning feeding first — creatures need it',
          nextNode: 'morning_feeding',
          effects: [{ variable: 'happiness', op: '+', value: 1 }],
        },
      ],
    ...
    enclosure_7: {
      ...
      choices: [
        {
          text: 'Back away slowly and relock the door',
          nextNode: 'park_open',
          effects: [{ variable: 'safety', op: '+', value: 1 }],
        },
        {
          text: 'Let it out — maybe it needs space',
          nextNode: 'creature_loose',
          effects: [
            { variable: 'safety', op: '-', value: 3 },
            { variable: 'happiness', op: '+', value: 2 },
          ],
        },
      ],
    },
    find_slime_hound: {
      ...
      choices: [
        {
          text: 'Open the park — crisis averted',
          nextNode: 'park_open',
          effects: [{ variable: 'safety', op: '+', value: 1 }],
        },
      ],
    ...
    calm_creature: {
      ...
      choices: [
        {
          text: "Open the park — you've earned it",
          nextNode: 'park_open',
          effects: [
            { variable: 'happiness', op: '+', value: 1 },
            { variable: 'safety', op: '+', value: 1 },
          ],
        },
      ],
    },
    park_open: {
      ...
      choices: [
        {
          text: 'A visitor claims a territorial-crab took his hat',
          nextNode: 'crab_incident',
          effects: [{ variable: 'profit', op: '+', value: 1 }],
        },
    ...
    creature_loose: {
      ...
      choices: [
        {
          text: 'Let it roam — this is incredible marketing',
          nextNode: 'end_of_day',
          effects: [
            { variable: 'profit', op: '+', value: 3 },
            { variable: 'happiness', op: '+', value: 2 },
          ],
        },
      ],
    ...
    crab_incident: {
      ...
      choices: [
        {
          text: 'Offer the crab a reflective feeding disk',
          nextNode: 'end_of_day',
          effects: [
            { variable: 'happiness', op: '+', value: 1 },
            { variable: 'profit', op: '+', value: 1 },
          ],
        },
        {
          text: 'Offer the visitor a complimentary hat from the gift shop',
          nextNode: 'end_of_day',
          effects: [
            { variable: 'profit', op: '-', value: 1 },
            { variable: 'happiness', op: '+', value: 1 },
    ...
    end_of_day: {
      ...
      choices: [
        {
          text: 'A perfect day — check outcome',
          nextNode: 'ending_perfect',
          condition: { variable: 'happiness', op: '>=', value: 7 },
        },
        {
          text: 'Incident report required — check outcome',
          nextNode: 'ending_incident',
          condition: { variable: 'safety', op: '<=', value: 2 },
        },
        {
          text: 'Profitable chaos — check outcome',
          nextNode: 'ending_profit',
          condition: { variable: 'profit', op: '>=', value: 4 },
        },
...
const QUEST_SMUGGLERS_RUN: TextQuest = {
  ...
  description:
    "High-value cargo, restricted space, and enough credits to fund a ship refit. The job is simple: pick up, deliver, don't get caught. You've done harder things. Probably.",
  ...
  nodes: {
    start: {
      ...
      choices: [
        ...
        {
          text: 'Take the job and ask no questions',
          nextNode: 'load_cargo',
          effects: [{ variable: 'credits', op: '+', value: 100 }],
        },
    ...
    check_manifest: {
      ...
      choices: [
        {
          text: 'Install a hidden compartment — takes an hour but reduces risk',
          nextNode: 'hidden_compartment',
          effects: [{ variable: 'suspicion', op: '-', value: 1 }],
        },
    ...
    hidden_compartment: {
      ...
      choices: [{ text: 'Proceed through the Orvan Corridor', nextNode: 'first_checkpoint' }],
    },
    outer_loop: {
      id: 'outer_loop',
      ...
      choices: [
        {
          text: 'Respond to the distress signal',
          nextNode: 'distress_signal',
          effects: [{ variable: 'suspicion', op: '+', value: 1 }],
        },
        {
          text: 'Log the signal and keep moving',
          nextNode: 'final_delivery',
          effects: [{ variable: 'credits', op: '+', value: 100 }],
        },
      ],
    },
    ...
    pirate_territory: {
      ...
      choices: [
        {
          text: 'Pay the toll — one crate is acceptable losses',
          nextNode: 'pay_toll',
          effects: [{ variable: 'cargo', op: '-', value: 1 }],
        },
    ...
    pass_checkpoint: {
      ...
      image: '/quests/drugs_05.jpg',
      choices: [{ text: 'Continue to the second checkpoint', nextNode: 'second_checkpoint' }],
    },
    bluff_inspection: {
      id: 'bluff_inspection',
    ...
    run_checkpoint: {
      ...
      choices: [
        {
          text: 'Push through to delivery — no more stops',
          nextNode: 'second_checkpoint',
          effects: [{ variable: 'suspicion', op: '+', value: 2 }],
        },
      ],
    },
    second_checkpoint: {
      ...
      choices: [
        ...
        {
          text: 'Divert through the nebula edge — avoid checkpoint entirely',
          nextNode: 'nebula_divert',
          effects: [{ variable: 'suspicion', op: '+', value: 1 }],
        },
      ],
    },
    suspicion_check: {
      ...
      choices: [
        {
          text: 'High suspicion — they detain you',
          nextNode: 'ending_caught',
          condition: { variable: 'suspicion', op: '>=', value: 3 },
        },
        {
          text: 'Low suspicion — cleared through',
          nextNode: 'final_delivery',
          condition: { variable: 'suspicion', op: '<=', value: 2 },
        },
      ],
    },
    distress_signal: {
      ...
      choices: [
        {
          text: "Continue to delivery — you're now running late",
          nextNode: 'final_delivery',
          effects: [{ variable: 'credits', op: '-', value: 50 }],
        },
      ],
    },
    nebula_divert: {
      ...
      choices: [
        {
          text: 'Push to the delivery point at maximum speed',
          nextNode: 'final_delivery',
          skillCheck: { stat: 'speed', min: 45 },
        },
    ...
    pay_toll: {
      ...
      image: '/quests/drugs_03.jpg',
      choices: [{ text: 'Continue to the delivery point', nextNode: 'final_delivery' }],
    },
    fight_pirates: {
      id: 'fight_pirates',
    ...
    negotiate_pirates: {
      ...
      choices: [
        ...
        {
          text: 'Sell the cargo to pirates instead',
          nextNode: 'ending_sold_to_pirates',
          effects: [
            { variable: 'cargo', op: '=', value: 0 },
            { variable: 'credits', op: '+', value: 200 },
          ],
        },
      ],
    },
    final_delivery: {
      ...
      choices: [
        {
          text: 'Full cargo delivered clean — collect the big payout',
          nextNode: 'ending_legendary',
          condition: { variable: 'cargo', op: '>=', value: 5 },
        },
        {
          text: 'Caught and searched — job failed',
          nextNode: 'ending_caught',
          condition: { variable: 'suspicion', op: '>=', value: 3 },
        },
...
const QUEST_WORMHOLE_GAMBIT: TextQuest = {
  ...
  description:
    'An unstable wormhole opens near your patrol route. Scientists, military, and smugglers all want it. What will you do?',
  ...
  nodes: {
    start: {
      ...
      choices: [
        ...
        {
          text: 'Ignore all — fly straight into the wormhole',
          nextNode: 'dive_blind',
          skillCheck: { stat: 'luck', min: 70 },
        },
      ],
    ...
    scientists: {
      ...
      choices: [
        ...
        {
          text: 'Launch a probe instead — safer',
          nextNode: 'probe_launch',
          effects: [{ variable: 'data', op: '+', value: 3 }],
        },
    ...
    military: {
      ...
      choices: [
        {
          text: 'Accept — plant the beacon',
          nextNode: 'plant_beacon',
          effects: [{ variable: 'risk', op: '+', value: 3 }],
        },
    ...
    smugglers: {
      ...
      choices: [
        {
          text: 'Agree — fly through the wormhole',
          nextNode: 'enter_wormhole',
          effects: [{ variable: 'risk', op: '+', value: 4 }],
        },
    ...
    scan_close: {
      ...
      choices: [
        {
          text: 'Pull back and deliver the data',
          nextNode: 'ending_science',
          effects: [{ variable: 'data', op: '+', value: 8 }],
        },
        {
          text: "Push deeper — there's something inside",
          nextNode: 'enter_wormhole',
          skillCheck: { stat: 'shield', min: 40 },
        },
      ],
    },
    probe_launch: {
      ...
      choices: [
        ...
        {
          text: 'Keep the data — fly through yourself',
          nextNode: 'enter_wormhole',
          effects: [{ variable: 'risk', op: '+', value: 2 }],
        },
    ...
    plant_beacon: {
      ...
      choices: [
        {
          text: 'Full burn away — fight the pull',
          nextNode: 'ending_military',
          skillCheck: { stat: 'speed', min: 50 },
        },
    ...
    refuse_military: {
      ...
      choices: [
        {
          text: 'Rush in and scan before they destroy it',
          nextNode: 'scan_close',
          effects: [{ variable: 'risk', op: '+', value: 3 }],
        },
    ...
    enter_wormhole: {
      ...
      choices: [
        {
          text: 'Mark the exit coordinates — jackpot!',
          nextNode: 'ending_explorer',
          effects: [{ variable: 'data', op: '+', value: 10 }],
        },
        {
          text: 'Turn around before the wormhole closes',
          nextNode: 'ending_survivor',
          condition: { variable: 'risk', op: '<=', value: 3 },
        },
        {
          text: 'Ship is damaged — send distress beacon',
          nextNode: 'ending_stranded',
          condition: { variable: 'risk', op: '>=', value: 4 },
        },
      ],
    },
    dive_blind: {
      ...
      image: '/quests/sr2_00.jpg',
      choices: [{ text: 'Record everything and head back', nextNode: 'ending_daredevil' }],
    },
    report_smuggler: {
      id: 'report_smuggler',
...
const QUEST_LIVING_CITY: TextQuest = {
  ...
  description:
    'A robot city has developed a collective consciousness. Its mood shifts with every interaction. Navigate carefully.',
  ...
  nodes: {
    ...
    city_core: {
      ...
      choices: [
        {
          text: 'Yes — they deserve to know',
          nextNode: 'reveal_truth',
          effects: [{ variable: 'mood', op: '-', value: 3 }],
        },
        {
          text: 'No — keep it secret, study it first',
          nextNode: 'study_core',
          effects: [{ variable: 'knowledge', op: '+', value: 3 }],
        },
    ...
    sick_sector: {
      ...
      choices: [
        {
          text: "Analyze the dead robots' circuits",
          nextNode: 'virus_sector',
          effects: [{ variable: 'knowledge', op: '+', value: 3 }],
        },
    ...
    virus_sector: {
      ...
      choices: [
        ...
        {
          text: 'Trace the virus back to its source',
          nextNode: 'trace_source',
          effects: [{ variable: 'knowledge', op: '+', value: 2 }],
        },
        {
          text: 'Warn Nexus — it needs to fight this itself',
          nextNode: 'warn_nexus',
          effects: [{ variable: 'trust', op: '+', value: 3 }],
        },
      ],
    },
    reveal_truth: {
    ...
    study_core: {
      ...
      choices: [
        {
          text: 'Protect Nexus — delete the data',
          nextNode: 'ending_protector',
          effects: [{ variable: 'trust', op: '+', value: 5 }],
        },
        {
          text: 'Copy the data to sell later',
          nextNode: 'ending_betrayal',
          effects: [{ variable: 'trust', op: '-', value: 10 }],
        },
      ],
    },
    nexus_desire: {
      ...
      choices: [
        {
          text: 'Help diagnose the sickness',
          nextNode: 'virus_sector',
          effects: [{ variable: 'trust', op: '+', value: 2 }],
        },
    ...
    reboot_attempt: {
      ...
      image: '/quests/sr2_22.jpg',
      choices: [{ text: 'Go to Sector 7', nextNode: 'trace_source' }],
    },
    purge_virus: {
      id: 'purge_virus',
      ...
      choices: [{ text: "Accept Nexus's gratitude", nextNode: 'ending_savior' }],
    },
    trace_source: {
      id: 'trace_source',
      ...
      choices: [
        {
          text: 'Broadcast the evidence publicly',
          nextNode: 'ending_whistleblower',
          effects: [{ variable: 'trust', op: '+', value: 5 }],
        },
        { text: "Sell the evidence to MegaCorp's rival", nextNode: 'ending_profiteer' },
        {
          text: 'Give it to Nexus — let the city decide',
          nextNode: 'ending_savior',
          effects: [{ variable: 'trust', op: '+', value: 3 }],
        },
      ],
    },
    ...
    calm_riots: {
      ...
      image: '/quests/sr2_02.jpg',
      choices: [{ text: 'Stay for the first council meeting', nextNode: 'ending_peacemaker' }],
    },
    ending_flee: {
      id: 'ending_flee',
...
const QUEST_GALACTIC_JACKPOT: TextQuest = {
  ...
  nodes: {
    ...
    round_one: {
      ...
      choices: [
        {
          text: 'Trust your instincts — pick fast',
          nextNode: 'round_one_result',
          skillCheck: { stat: 'luck', min: 30 },
        },
        {
          text: 'Analyze the pattern carefully',
          nextNode: 'round_one_result',
          effects: [{ variable: 'score', op: '+', value: 2 }],
        },
      ],
    },
    round_one_result: {
      ...
      choices: [
        ...
        {
          text: 'Confront the host about rigging',
          nextNode: 'confront_host',
          effects: [{ variable: 'integrity', op: '+', value: 3 }],
        },
      ],
    },
    backstage: {
      ...
      choices: [
        {
          text: 'Pay him — guarantee a win',
          nextNode: 'rigged_path',
          effects: [{ variable: 'integrity', op: '-', value: 5 }],
        },
    ...
    rigged_path: {
      ...
      choices: [
        {
          text: 'Go for the Grand Prize',
          nextNode: 'ending_cheater_win',
          condition: { variable: 'integrity', op: '<=', value: 2 },
        },
        { text: 'Take the money and quit before caught', nextNode: 'ending_cautious_cheat' },
        {
          text: 'Confess on live TV',
          nextNode: 'ending_redemption',
          effects: [{ variable: 'integrity', op: '+', value: 10 }],
        },
      ],
    },
    confront_host: {
      ...
      choices: [
        {
          text: 'Finish the exposé on camera',
          nextNode: 'ending_whistleblower',
          effects: [{ variable: 'fame', op: '+', value: 10 }],
        },
      ],
    },
    report_fixer: {
      ...
      choices: [
        {
          text: 'Play the show — fair and square',
          nextNode: 'round_one',
          effects: [
            { variable: 'score', op: '+', value: 2 },
            { variable: 'integrity', op: '+', value: 3 },
          ],
        },
      ],
    },
    ...
    door_silver: {
      ...
      image: '/quests/sr2_21.jpg',
      choices: [{ text: 'Take the bonds happily', nextNode: 'ending_safe_prize' }],
    },
    door_mystery: {
      id: 'door_mystery',
...
const QUEST_JUNGLE_SURVEY: TextQuest = {
  ...
  title: 'Jungle Survey',
  description:
    'A science team hired you to survey a jungle planet. Ancient ruins, deadly creatures, and hostile natives await.',
  ...
  nodes: {
    ...
    orbital_scan: {
      ...
      choices: [
        ...
        {
          text: 'Land at Site B — near the settlement',
          nextNode: 'native_village',
          effects: [{ variable: 'native_trust', op: '+', value: 1 }],
        },
    ...
    landing: {
      ...
      choices: [
        {
          text: 'Push through the jungle to Site A',
          nextNode: 'jungle_trek',
          effects: [{ variable: 'danger', op: '+', value: 2 }],
        },
    ...
    crashed_ship: {
      ...
      choices: [
        {
          text: 'Help him and take the manifest',
          nextNode: 'jungle_trek',
          effects: [{ variable: 'samples', op: '+', value: 3 }],
        },
        {
          text: 'Leave him — not your problem',
          nextNode: 'jungle_trek',
          effects: [{ variable: 'danger', op: '+', value: 1 }],
        },
      ],
    },
    jungle_trek: {
      ...
      choices: [
        {
          text: 'Fire warning shots to scare them',
          nextNode: 'scare_beasts',
          skillCheck: { stat: 'firepower', min: 40 },
        },
        { text: 'Back away slowly — find another route', nextNode: 'river_path' },
        {
          text: 'Stand perfectly still — wait them out',
          nextNode: 'wait_beasts',
          skillCheck: { stat: 'luck', min: 45 },
        },
      ],
    },
    scare_beasts: {
      ...
      choices: [
        {
          text: 'Collect samples at Site A',
          nextNode: 'site_a',
          effects: [{ variable: 'samples', op: '+', value: 4 }],
        },
      ],
    },
    wait_beasts: {
    ...
    river_path: {
      ...
      choices: [
        {
          text: 'Approach peacefully — hands visible',
          nextNode: 'native_village',
          effects: [{ variable: 'native_trust', op: '+', value: 2 }],
        },
        {
          text: 'Avoid them — circle to Site A',
          nextNode: 'site_a',
          effects: [{ variable: 'samples', op: '+', value: 2 }],
        },
      ],
    },
    native_village: {
      ...
      choices: [
        {
          text: 'Offer a gift from your supplies',
          nextNode: 'native_friendly',
          effects: [{ variable: 'native_trust', op: '+', value: 3 }],
        },
        {
          text: 'Show your scanner — demonstrate technology',
          nextNode: 'native_curious',
          effects: [{ variable: 'native_trust', op: '+', value: 1 }],
        },
        {
          text: 'Back away — too dangerous',
          nextNode: 'site_a',
          effects: [{ variable: 'samples', op: '+', value: 2 }],
        },
      ],
    ...
    native_friendly: {
      ...
      choices: [
        {
          text: 'Collect crystal samples carefully',
          nextNode: 'ending_alliance',
          effects: [{ variable: 'samples', op: '+', value: 8 }],
        },
        {
          text: 'Ask to map the full cave system',
          nextNode: 'ending_discovery',
          effects: [{ variable: 'samples', op: '+', value: 6 }],
        },
      ],
    },
    native_curious: {
      ...
      choices: [
        {
          text: 'Take only small samples — respect their land',
          nextNode: 'ending_respectful',
          effects: [{ variable: 'samples', op: '+', value: 5 }],
        },
        {
          text: 'Mark the deposits for the science team',
          nextNode: 'ending_corporate',
          effects: [
            { variable: 'samples', op: '+', value: 7 },
            { variable: 'native_trust', op: '-', value: 5 },
          ],
        },
      ],
    },
    site_a: {
      ...
      choices: [
        {
          text: 'Collect maximum samples — risk more time',
          nextNode: 'ending_thorough',
          effects: [
            { variable: 'samples', op: '+', value: 5 },
            { variable: 'danger', op: '+', value: 3 },
          ],
        },
        {
          text: 'Grab what you can and leave fast',
          nextNode: 'ending_quick',
          effects: [{ variable: 'samples', op: '+', value: 3 }],
        },
      ],
    },
...
const QUEST_PLAGUE_SHIP: TextQuest = {
  ...
  title: 'Plague Ship',
  description:
    'A hospital ship sends a distress signal. A mysterious disease is killing the crew. Can you find a cure in time?',
  ...
  nodes: {
    ...
    call_backup: {
      ...
      image: '/quests/sr2_17.jpg',
      choices: [{ text: 'Board the ship', nextNode: 'boarding' }],
    },
    examine_ward: {
      id: 'examine_ward',
      ...
      choices: [
        {
          text: 'Take blood samples for analysis',
          nextNode: 'lab_analysis',
          effects: [{ variable: 'cure_progress', op: '+', value: 2 }],
        },
    ...
    find_doctor: {
      ...
      choices: [
        {
          text: 'Volunteer yourself as test subject',
          nextNode: 'self_test',
          effects: [
            { variable: 'infected', op: '+', value: 1 },
            { variable: 'cure_progress', op: '+', value: 5 },
          ],
        },
        {
          text: 'Help her refine the counter-agent first',
          nextNode: 'lab_analysis',
          effects: [{ variable: 'cure_progress', op: '+', value: 3 }],
        },
    ...
    lab_analysis: {
      ...
      choices: [
        {
          text: "Search the ship's pharmacy for the catalyst",
          nextNode: 'pharmacy',
          effects: [{ variable: 'cure_progress', op: '+', value: 2 }],
        },
    ...
    stabilize: {
      ...
      choices: [
        ...
        {
          text: "Find Dr. Taren's research",
          nextNode: 'find_doctor',
          effects: [{ variable: 'crew_alive', op: '+', value: 2 }],
        },
      ],
    },
    find_source: {
      ...
      choices: [
        {
          text: 'Interrogate the suspects',
          nextNode: 'ending_detective',
          effects: [{ variable: 'cure_progress', op: '+', value: 2 }],
        },
        {
          text: 'Focus on the cure — justice can wait',
          nextNode: 'lab_analysis',
          effects: [{ variable: 'cure_progress', op: '+', value: 3 }],
        },
      ],
    ...
    pharmacy: {
      ...
      choices: [
        {
          text: 'Rush the vials to the lab',
          nextNode: 'ending_cure',
          effects: [{ variable: 'cure_progress', op: '+', value: 5 }],
        },
      ],
    },
    elder_wisdom: {
      ...
      choices: [
        {
          text: 'Get the Stellaria root — could be the catalyst!',
          nextNode: 'ending_traditional',
          effects: [{ variable: 'cure_progress', op: '+', value: 4 }],
        },
        {
          text: 'Combine her knowledge with the lab data',
          nextNode: 'ending_cure',
          effects: [{ variable: 'cure_progress', op: '+', value: 6 }],
        },
      ],
    },
    self_test: {
      ...
      image: '/quests/sr2_10.jpg',
      choices: [{ text: 'Help distribute the cure', nextNode: 'ending_hero' }],
    },
    synthesize: {
      id: 'synthesize',
      ...
      image: '/quests/sr2_24.jpg',
      choices: [{ text: 'Administer to all patients', nextNode: 'ending_partial_cure' }],
    },
    ending_abandon: {
      id: 'ending_abandon',
...
const QUEST_FORTRESS_HEIST: TextQuest = {
  ...
  description:
    'A corporate whistleblower needs data stolen from the most secure building in the sector. Stealth, force, or wit — choose wisely.',
  ...
  nodes: {
    start: {
      ...
      choices: [
        ...
        {
          text: 'Service entrance — maintenance disguise',
          nextNode: 'service_entry',
          effects: [{ variable: 'stealth', op: '+', value: 3 }],
        },
    ...
    lobby: {
      ...
      choices: [
        ...
        {
          text: '"Floor 5. Just a meeting."',
          nextNode: 'floor_5_detour',
          effects: [{ variable: 'stealth', op: '+', value: 1 }],
        },
        {
          text: 'Distract him — spill your coffee',
          nextNode: 'distract_guard',
          effects: [{ variable: 'stealth', op: '+', value: 2 }],
        },
      ],
    },
    service_entry: {
      ...
      choices: [
        ...
        {
          text: 'Take the stairs — slower but no cameras',
          nextNode: 'stairwell',
          effects: [{ variable: 'stealth', op: '+', value: 2 }],
        },
      ],
    ...
    roof_entry: {
      ...
      choices: [
        {
          text: 'Drop into Floor 22 corridor',
          nextNode: 'corridor_22',
          effects: [{ variable: 'stealth', op: '+', value: 3 }],
        },
      ],
    },
    distract_guard: {
      ...
      image: '/quests/sr2_31.jpg',
      choices: [{ text: 'Ride to Floor 22', nextNode: 'corridor_22' }],
    },
    floor_5_detour: {
      id: 'floor_5_detour',
      ...
      choices: [
        {
          text: 'Head to Floor 22 via maintenance shaft',
          nextNode: 'corridor_22',
          effects: [{ variable: 'stealth', op: '+', value: 3 }],
        },
      ],
    ...
    elevator_22: {
      ...
      choices: [
        {
          text: 'Time the cameras and move',
          nextNode: 'corridor_22',
          effects: [{ variable: 'stealth', op: '+', value: 1 }],
        },
      ],
    ...
    floor_20: {
      ...
      image: '/quests/sr2_18.jpg',
      choices: [{ text: 'Enter Floor 22', nextNode: 'corridor_22' }],
    },
    stairwell: {
      id: 'stairwell',
    ...
    corridor_22: {
      ...
      choices: [
        {
          text: 'Use the keycard on the door',
          nextNode: 'server_room',
          condition: { variable: 'stealth', op: '>=', value: 5 },
        },
        {
        ...
        {
          text: 'Use the keycard on the door',
          nextNode: 'alarm_triggered',
          condition: { variable: 'stealth', op: '<=', value: 4 },
        },
      ],
    },
    server_room: {
      ...
      choices: [
        {
          text: 'Take only the evidence files',
          nextNode: 'ending_clean_heist',
          effects: [{ variable: 'data', op: '+', value: 5 }],
        },
        {
          text: 'Copy everything — more leverage',
          nextNode: 'ending_full_download',
          effects: [
            { variable: 'data', op: '+', value: 10 },
            { variable: 'alarm', op: '+', value: 3 },
          ],
        },
        {
          text: "Plant a virus while you're at it",
          nextNode: 'ending_sabotage',
          effects: [{ variable: 'alarm', op: '+', value: 5 }],
        },
      ],
    },
    alarm_triggered: {
      ...
      choices: [
        {
          text: 'Smash the door — grab what you can',
          nextNode: 'server_room',
          effects: [{ variable: 'alarm', op: '+', value: 5 }],
        },
  ...
  nodes: {
    start: {
      ...
      choices: [
        ...
        {
          text: '"What\'s the real story? Dominators don\'t hit random colonies."',
          nextNode: 'real_story',
          effects: [{ variable: 'honor', op: '+', value: 2 }],
        },
    ...
    briefing: {
      ...
      choices: [
        ...
        {
          text: 'Ask for more pay — this is dangerous',
          nextNode: 'negotiate_pay',
          effects: [{ variable: 'honor', op: '-', value: 1 }],
        },
      ],
    },
    real_story: {
    ...
    negotiate_pay: {
      ...
      image: '/quests/sr2_47.jpg',
      choices: [{ text: 'Shake on it', nextNode: 'day_one' }],
    },
    day_one: {
      id: 'day_one',
      ...
      choices: [
        {
          text: 'Engage aggressively — send a message',
          nextNode: 'fight_scouts',
          skillCheck: { stat: 'firepower', min: 40 },
        },
        {
          text: 'Defensive posture — protect the colony',
          nextNode: 'defend_colony',
          skillCheck: { stat: 'shield', min: 40 },
        },
      ],
    },
    fight_scouts: {
      ...
      choices: [
        {
          text: 'Rest and prepare for Day Two',
          nextNode: 'day_two',
          effects: [
            { variable: 'kills', op: '+', value: 2 },
            { variable: 'morale', op: '+', value: 2 },
          ],
        },
      ],
    },
      ...
      choices: [
        {
          text: 'Rest and prepare for Day Two',
          nextNode: 'day_two',
          effects: [{ variable: 'morale', op: '+', value: 1 }],
        },
      ],
    },
    day_two: {
      ...
      choices: [
        {
          text: 'Focus on the bomber — stop the devastation',
          nextNode: 'attack_bomber',
          skillCheck: { stat: 'firepower', min: 50 },
        },
        {
          text: 'Save your wingman first',
          nextNode: 'save_wingman',
          effects: [{ variable: 'honor', op: '+', value: 3 }],
        },
        {
          text: 'Break formation — fight your own battle',
          nextNode: 'solo_fight',
          skillCheck: { stat: 'speed', min: 55 },
        },
      ],
    },
    attack_bomber: {
      ...
      choices: [
        {
          text: 'Regroup for Day Three',
          nextNode: 'day_three',
          effects: [
            { variable: 'kills', op: '+', value: 3 },
            { variable: 'morale', op: '+', value: 3 },
          ],
        },
      ],
    },
    ...
    solo_fight: {
      ...
      choices: [
        {
          text: 'Accept the criticism — refocus',
          nextNode: 'day_three',
          effects: [
            { variable: 'kills', op: '+', value: 4 },
            { variable: 'honor', op: '-', value: 2 },
          ],
        },
      ],
    },
    day_three: {
      ...
      choices: [
        {
          text: 'Hold the line — fight to the last',
          nextNode: 'ending_hold_line',
          effects: [{ variable: 'kills', op: '+', value: 3 }],
        },
        {
          text: 'Lead a counterattack — push them back',
          nextNode: 'ending_counterattack',
          skillCheck: { stat: 'firepower', min: 55 },
        },
        {
          text: 'Focus on civilian evacuation',
          nextNode: 'ending_evacuation',
          effects: [{ variable: 'honor', op: '+', value: 5 }],
        },
      ],
    },
    ending_decline: {
...
const QUEST_ALIEN_EMBASSY: TextQuest = {
  ...
  title: 'Alien Embassy',
  description:
    'A diplomatic mission to an alien world. Cultural misunderstandings could spark an incident — or forge an alliance.',
  ...
  nodes: {
    ...
    taxi_wisdom: {
      ...
      choices: [
        {
          text: 'Thanks — head to the embassy',
          nextNode: 'council_hall',
          effects: [{ variable: 'cultural_points', op: '+', value: 3 }],
        },
      ],
    },
    council_hall: {
      ...
      choices: [
        {
          text: 'Accept the meal graciously',
          nextNode: 'shared_meal',
          effects: [{ variable: 'reputation', op: '+', value: 2 }],
        },
        {
          text: "Offer a gift first — it's human custom",
          nextNode: 'gift_exchange',
          effects: [{ variable: 'gifts', op: '+', value: 1 }],
        },
    ...
    shared_meal: {
      ...
      choices: [
        {
          text: 'Drink the Zyrka juice and eat everything',
          nextNode: 'meal_success',
          effects: [
            { variable: 'reputation', op: '+', value: 3 },
            { variable: 'cultural_points', op: '+', value: 2 },
          ],
        },
        {
          text: 'Politely try a small portion',
          nextNode: 'meal_polite',
          effects: [{ variable: 'reputation', op: '+', value: 1 }],
        },
        {
          text: "Can't do it — make an excuse",
          nextNode: 'meal_refuse',
          effects: [{ variable: 'reputation', op: '-', value: 3 }],
        },
      ],
    },
    meal_success: {
      ...
      choices: [
        {
          text: 'Share a human story in return',
          nextNode: 'cultural_exchange',
          effects: [{ variable: 'cultural_points', op: '+', value: 3 }],
        },
    ...
    city_tour: {
      ...
      choices: [
        ...
        {
          text: "Visit Dr. Zeen's laboratory",
          nextNode: 'tech_tour',
          effects: [{ variable: 'cultural_points', op: '+', value: 2 }],
        },
    ...
    gym_attempt: {
      ...
      choices: [
        {
          text: 'Laugh along and continue the tour',
          nextNode: 'tech_tour',
          effects: [{ variable: 'reputation', op: '+', value: 3 }],
        },
      ],
    ...
    tech_tour: {
      ...
      choices: [
        {
          text: 'Accept graciously and offer human research in return',
          nextNode: 'ending_alliance',
          effects: [{ variable: 'cultural_points', op: '+', value: 3 }],
        },
        {
          text: 'Accept and ask about military applications',
          nextNode: 'ending_suspicious',
          effects: [{ variable: 'reputation', op: '-', value: 2 }],
        },
      ],
    },
    alien_pets: {
      ...
      choices: [
        {
          text: 'Accept the Purrik — an interspecies friendship!',
          nextNode: 'ending_friendship',
          effects: [{ variable: 'cultural_points', op: '+', value: 3 }],
        },
    ...
    apology: {
      ...
      choices: [
        {
          text: 'Eat the meal — all of it this time',
          nextNode: 'meal_success',
          effects: [{ variable: 'reputation', op: '+', value: 1 }],
        },
      ],
...
export function saveQuestState(state: QuestSaveState, address: string): void {
  ...
  // Sync completed quests to server (debounced)
  if (state.completed) {
    import('@/lib/userDataSync')
      .then(({ syncToServer }) => {
        syncToServer({ textQuests: { [state.questId]: state } });
      })
      .catch(() => {});
  }
}
...
function applyEffects(variables: Record<string, number>, effects?: QuestChoice['effects']): Record<string, number> {
  ...
  for (const e of effects) {
    ...
    switch (e.op) {
      case '+':
        updated[e.variable] = current + e.value;
        break;
      case '-':
        updated[e.variable] = current - e.value;
        break;
      case '=':
        updated[e.variable] = e.value;
        break;
    }
  }
  return updated;
...
export function getVisibleChoices(
  ...
  state: QuestSaveState,
  shipStats: ShipStats,
): (QuestChoice & { passesSkillCheck: boolean })[] {
  const node = quest.nodes[state.currentNode];
  if (!node) return [];
  return node.choices
