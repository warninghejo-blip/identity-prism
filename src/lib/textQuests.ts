...
const QUEST_ABANDONED_STATION: TextQuest = {
  ...
  nodes: {
    ...
    bridge: {
      ...
      image: '/quests/text_quest_ui.jpg',
      choices: [
...
const QUEST_PIRATE_AMBUSH: TextQuest = {
  ...
  image: '/quests/pirates_nebula.webp',
  difficulty: 'medium',
  ...
  nodes: {
    ...
    fight_start: {
      ...
      image: '/quests/space_encounter.webp',
      choices: [
    ...
    fight_aggressive: {
      ...
      image: '/quests/ground_battle.webp',
      choices: [
    ...
    bluff: {
      ...
      image: '/quests/patrol_dialog.webp',
      choices: [
...
const QUEST_DARK_MATTER: TextQuest = {
  ...
  nodes: {
    ...
    ending_cautious: {
      ...
      image: '/quests/ranger_ranking.jpg',
      choices: [],
      isEnding: true,
      reward: { coins: 100 },
    },
...
const QUEST_DOMINATOR_FACTORY: TextQuest = {
  ...
  image: '/quests/robot_factory.webp',
  difficulty: 'hard',
  estimatedTime: '7 min',
  startNode: 'start',
  ...
  nodes: {
    ...
    assembly_floor: {
      ...
      image: '/quests/dominator_rts.jpg',
      choices: [
