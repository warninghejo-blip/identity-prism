...
describe('Page smoke tests', () => {
  ...
  it('2 — Index page renders without crashing', async () => {
    const { default: IndexPage } = await import('@/pages-app/Index');
    const { container } = render(
      <Wrapper>
        <IndexPage />
      </Wrapper>,
  ...
  it('3 — Leaderboard page renders (skeleton acceptable)', async () => {
    const { default: LeaderboardPage } = await import('@/pages-app/Leaderboard');
    const { container } = render(
      <Wrapper>
        <LeaderboardPage />
      </Wrapper>,
  ...
  it('5 — PrismLeague page renders (mode selector visible)', async () => {
    const { default: PrismLeaguePage } = await import('@/pages-app/PrismLeague');
    const { container } = render(
      <Wrapper>
        <PrismLeaguePage />
      </Wrapper>,
